<div class="flex items-center gap-3 ml-6">
    ...
    <button @click="toggleTaskStatus()" 
        class="group/btn p-2 bg-zinc-700/50 rounded-lg border border-zinc-600 transition-all duration-300 hover:cursor-pointer"
    ...
    <button @click="deleteTask()" 
        class="group/btn p-2 bg-zinc-700/50 rounded-lg hover:bg-red-500/20 border border-zinc-600 hover:border-red-500/50 transition-all duration-300 hover:cursor-pointer">
